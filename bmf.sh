...
#		echo "Поток $ds"
#		for itog in {1..3}; do
#			./bimorph clump/iris.sqlite ds=$ds itog=$itog epoch=100; # ?cache=shareda
#		done
#	done
#done
#./bimorph clump/iris.sqlite ds=1 mem=:memory: itog=1 epoch=1 # ?cache=shared
#./bimorph clump/iris.sqlite ds=1 mem=:memory: itog=2 epoch=1 # ?cache=shared
#./bimorph clump/iris.sqlite ds=1 mem=:memory: itog=3 epoch=1 # ?cache=shared
#./bimorph clump/iris.sqlite ds=1 mem=:memory: itog=1 epoch=1 # ?cache=shared
#./bimorph clump/iris.sqlite ds=1 mem=:memory: itog=2 epoch=1 # ?cache=shared
#./bimorph clump/iris.sqlite ds=1 mem=:memory: itog=3 epoch=1 # ?cache=shared
#./bimorph clump/iris.sqlite ds=2 mem=:memory: itog=2 epoch=1 # ?cache=shared
...
#./bimorph clump/iris.sqlite ds=2 itog=1 epoch=100 # ?cache=shared
