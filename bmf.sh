...
#./bimorph mysql://tri:tri@192.168.1.6/tri ds=1 epoch=10 learn #verbose
...
./bimorph mysql://iris:iris@192.168.1.6/iris ds=1 epoch=0 learn #verbose=3 #key=+10 #-microtime # ?cache=shared
